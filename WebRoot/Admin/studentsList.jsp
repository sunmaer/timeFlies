  ...
  <body>
       ...
       <div class="main">
          ...
          <div class="container">
            <div class="name">
				<span>学生列表</span>
				<a href="addStudents.jsp"><i class="fa fa-plus"></i> 添加学生</a>
			</div><!-- name -->

			<div class="search">
				<form action="studentsSearch.do" method="post">
			...
			<div class="page">
               ...
               <a href="studentsList.do?pageNo=1">第一页</a> 
               <c:choose>
                   <c:when test="${page.pageNo > 1}">
                       <a href="studentsList.do?pageNo=${page.pageNo-1}">上一页</a>
                   </c:when>
                   <c:otherwise>
                                                                 上一页
                   </c:otherwise>
               ...
               <c:choose>
                   <c:when test="${page.pageNo < page.totalPage}">
                   	<a href="studentsList.do?pageNo=${page.pageNo+1}">下一页</a>
                   </c:when>
                   <c:otherwise>
                                                                 下一页
                   </c:otherwise>
               </c:choose> 
               <a href="studentsList.do?pageNo=${page.totalPage}">最末页</a> 
			</div>
