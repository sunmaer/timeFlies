			...
			<c:if test="${not empty studentsList}">
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" readonly="readonly" id="name" name="name" value="${student.name}"></td>
						<td class="textRight">学号</td>
						<td><input type="text" readonly="readonly" id="studentId" name="studentId" value="${student.studentId}"></td>
						<td class="textRight">宿舍</td>
						<td colspan="2"><input type="text" readonly="readonly" id="dorm" name="dorm" value="${student.dorm}"></td>
					</tr>
					<tr>
						<td class="textRight">C语言程序设计</td>
						<td><input type="text" readonly="readonly" id="c" name="c" value="${student.c}"></td>
						<td class="textRight">C++程序设计</td>
						<td><input type="text" readonly="readonly" id="cplus" name="cplus" value="${student.cplus}"></td>
						<td class="textRight">JAVA语言程序设计</td>
						<td><input type="text" readonly="readonly" id="java" name="java" value="${student.java}"></td>
					</tr>
					<tr>
						<td class="textRight">数据库系统概论</td>
						<td><input type="text" readonly="readonly" id="dataBase" name="dataBase" value="${student.dataBase}"></td>
						<td class="textRight">数据结构</td>
						<td><input type="text" readonly="readonly" id="dataStructures" name="dataStructures" value="${student.dataStructures}"></td>
						<td class="textRight">算法设计分析</td>
						<td><input type="text" readonly="readonly" id="algorithm" name="algorithm" value="${student.algorithm}"></td>
					</tr>
					<tr>
